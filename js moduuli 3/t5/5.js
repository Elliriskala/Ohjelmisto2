...
// Open t5 folder in your IDE/editor. Create multiple <article>
// elements that contain heading, image, image caption and text and
// populate them with the data from picArray. Add the articles to the
// <section> element. (5p)
...
picArray.forEach(function (picture){
  ...
  image.src = picture.image.large;
  image.alt = picture.image.medium;
